...
##The file is used to read the image files and save datasets to use.
...
#   3-> image_dims: The dimensions of the numpy array. The final resolution is specified right here
...
normal_train_30x40=read_folder(path_to_folder, pneumonia_flag, image_dims)
os.chdir("../../..")
